...
namespace Constants {
    ...
    /*
    SIGMOID_SCALE: Controls the steepness of the sigmoid function. A higher value will make the function steeper, meaning the ant's decision to follow the pheromone will be more strongly influenced by the pheromone level. You can adjust this value to control the ants' sensitivity to pheromone levels.
    SIGMOID_MIDPOINT: Determines the value of the pheromone level at which the ant has a 50% chance of following the trail. You can adjust this value to control the ants' threshold for following pheromones.
    */
